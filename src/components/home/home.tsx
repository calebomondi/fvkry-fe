            ...
            <div className="order-2 lg:order-1 ">
              ...
              <div className="flex flex-col space-y-5 justify-center items-center">
                ...
                <div className='flex space-x-4 justify-center items-center'>
                  <button className="md:px-6 px-4 py-3 bg-amber-500 rounded-lg text-base font-semibold hover:bg-amber-500 hover:scale-105 transition-all flex items-center">
                    Start Locking Now
